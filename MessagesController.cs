...
using System.Speech.Synthesis;//sound lib for text to speech
...
namespace Bot_Application2
{
    ...
    public class MessagesController : ApiController
    {
        ...
        {
            {
                ...
                {
                    await Conversation.SendAsync(activity, () => new MainDialog().DefaultIfException());
                }
        ...
        public class MainDialog : IDialog<object>
        {
            ...
            protected float lat { get; set; }
            protected float lng { get; set; }
            ...
            public async Task StartAsync(IDialogContext context)
            {
                ...
                context.Wait(HelloMsg);
            }
      
            public async Task HelloMsg(IDialogContext context, IAwaitable<IMessageActivity> argument)
            {
